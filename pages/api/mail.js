...
export default async function sendEmail(req, res){
  const { email, amount, userName, invoice, date } = req.body;
  console.log(req.body, 'Data dari email')
  const msg = {
    to: email,
              ...
              <table align="center" bgcolor="#ffffff" style="border-left: 10px solid white; border-right: 10px solid white; max-width: 600px; width: 100%;">
                  <tr height="80">
                      <td align="center" class="vertical-align-middle" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: middle;">
                          <a href="https://www.penateam.com/" target="_blank" style="-webkit-text-decoration-color: #F39F21; color: #F39F21; text-decoration: none; text-decoration-color: #F39F21;">
                              <img src="https://drive.google.com/uc?export=view&id=1weC8vFQhpBLCcLQYfiouM5dcW5YdQ_TN" alt="Pena" width="70" style="border: 0; font-size: 0; margin: 0; max-width: 100%; padding: 0;">
                          </a>
                      </td>
                  </tr>
              </table>
                  ...
                  <td style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                      ...
                      <table align="center" cellpadding="0" cellspacing="0" cols="3" bgcolor="white" class="bordered-left-right" style="border-left: 10px solid #d7d7d7; border-right: 10px solid #d7d7d7; max-width: 600px; width: 100%;">
                          ...
                          <tr align="center">
                              ...
                              <td class="text-primary" style="color: #F39F21; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                                  <img src="http://dgtlmrktng.s3.amazonaws.com/go/emails/generic-email-template/tick.png" alt="Pena" width="50" style="border: 0; font-size: 0; margin: 0; max-width: 100%; padding: 0;">
                              </td>
                              <td width="36" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;"></td>
                          </tr>
                          ...
                          <tr align="center">
                              <td width="36" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;"></td>
                              <td class="text-primary" style="color: #F39F21; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                                  <h1 style="color: #F39F21; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 30px; font-weight: 700; line-height: 34px; margin-bottom: 0; margin-top: 0;">Payment received</h1>
                              </td>
                              <td width="36" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;"></td>
                          </tr>
                          ...
                          <tr align="left">
                              <td width="36" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;"></td>
                              <td style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                                  <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;">Congrats! Your transaction was successful</p>
                                  <br>
                          ...
                          <tr align="center">
                              <td width="36" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;"></td>
                              <td style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                                  <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;"><strong>Invoice: ${invoice}</strong></p>
              ...
              <table align="center" bgcolor="#464646" style="max-width: 600px; width: 100%;">
                  ...
                  <tr>
                      <td align="center" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                          <img src="https://drive.google.com/uc?export=view&id=1weC8vFQhpBLCcLQYfiouM5dcW5YdQ_TN" alt="Pena" width="50" style="border: 0; font-size: 0; margin: 0; max-width: 100%; padding: 0;">
                      </td>
                  </tr>
                  ...
                  <tr>
                      <td align="center" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                          <p class="text-white" style="color: white; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;">Copyright © Penateam 2023. All rights reserved.</p>
                          <p class="text-primary" style="color: #F39F21; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;">
                          </p>
                      </td>
                  </tr>
                  ...
                  <tr>
                      <td align="center" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                          <a href="https://www.twitter.com/penateam" style="-webkit-text-decoration-color: #464646; color: #F39F21; text-decoration: none; text-decoration-color: #464646;"><img width="25" htight="25" src="http://dgtlmrktng.s3.amazonaws.com/go/emails/generic-email-template/twitter.png" target="_blank" alt="Twitter" style="border: 0; font-size: 0; margin: 0; max-width: 100%; padding: 0;"></a>&nbsp;
                          <a href="https://www.youtube.com/user/penateam" style="-webkit-text-decoration-color: #464646; color: #F39F21; text-decoration: none; text-decoration-color: #464646;"><img width="25" htight="25" src="http://dgtlmrktng.s3.amazonaws.com/go/emails/generic-email-template/youtube.png" target="_blank" alt="Youtube" style="border: 0; font-size: 0; margin: 0; max-width: 100%; padding: 0;"></a>&nbsp;
                          <a href="https://www.linkedin.com/company/penawriter/about/" style="-webkit-text-decoration-color: #464646; color: #F39F21; text-decoration: none; text-decoration-color: #464646;"><img width="25" htight="25" src="http://dgtlmrktng.s3.amazonaws.com/go/emails/generic-email-template/linkedin.png" target="_blank" alt="LinkedIn" style="border: 0; font-size: 0; margin: 0; max-width: 100%; padding: 0;"></a>&nbsp;
                      </td>
                  </tr>
